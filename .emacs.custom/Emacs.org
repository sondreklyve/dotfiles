...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq org-todo-keywords
          '((sequence "TODO(t)" "NEXT(n)" "|" "DONE(d!)")
            (sequence "KJEMI(k)" "OS(O)" "OPTIKK(o)" "VITBER(v)" "NUMFYS(N)")))
    ...
    (setq org-agenda-custom-commands
          '(("d" "Dashboard"
            ...
            ("w" "Workflow Status"
             ((todo "KJEMI"
                    ((org-agenda-overriding-header "Kjemi")
                     (org-agenda-files org-agenda-files)))
              (todo "OS"
                    ((org-agenda-overriding-header "Operativsystemer")
                     (org-agenda-files org-agenda-files)))
              (todo "OPTIKK"
                    ((org-agenda-overriding-header "Optikk")
                     (org-agenda-todo-list-sublevels nil)
                     (org-agenda-files org-agenda-files)))
              (todo "VITBER"
                    ((org-agenda-overriding-header "Introduksjon til vitenskapelige beregninger")
                     (org-agenda-todo-list-sublevels nil)
                     (org-agenda-files org-agenda-files)))
              (todo "NUMFYS"
                    ((org-agenda-overriding-header "Numerisk Fysikk")
                     (org-agenda-files org-agenda-files)))
              (org-agenda-files org-agenda-files)))))
    ...
    (setq org-capture-templates
            '(("j" "Journal" entry
             (file+olp+datetree "~/semester4/journal.org")
  ...
  (use-package org-roam
    ...
    :custom
    (org-roam-directory "~/semester4/journal_space")
